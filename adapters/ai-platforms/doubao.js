// adapters/ai-platforms/doubao.js
// 豆包 AI 平台适配器

import AIPlatformAdapter from './base.js';

class DoubaoAdapter extends AIPlatformAdapter {
  constructor() {
    super();
    this.name = 'doubao';
    this.displayName = '豆包 (字节跳动)';
    this.matchPatterns = [
      '*://www.doubao.com/*',
      '*://doubao.com/*'
    ];
  ...
  async pasteImages(base64Images) {
    ...
    for (let i = 0; i < base64Images.length; i++) {
      ...
      console.log(`[豆包] 粘贴图片 ${i + 1}/${base64Images.length}`);
